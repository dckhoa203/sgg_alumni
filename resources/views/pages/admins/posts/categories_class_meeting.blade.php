...
<div class="container">
    ...
    <div class="content-border pager-offset">
        <h2 class="black-bar-header">BẢN TIN HỌP LỚP</h2>
                                ...
                                <div class="field field-name-field-article-media field-type-file field-label-hidden">
                                        ...
                                        <div class="field field-name-field-article-media field-type-file field-label-hidden">
                                            <div class="file file-image file-image-jpeg" id="file-1321">
                                                <img width="320" height="180" alt="" src="{{asset('/images/myfiles_cit/test_posts/pictures-employees-working-together-176287-8614351.jpg')}}" typeof="foaf:Image">
                                            </div>
                                        </div>
                                    </a>
