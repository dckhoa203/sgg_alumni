...
@section('content')
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Post of yourself</h3>
            </div>
            <div class="panel-body">
                <div id="post_list">
                    ...
                    <div class="jumbotron" style="padding:24px 30px 24px 30px">
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <img src="{{asset('/images/myfiles_cit/doc.png')}}" alt="bai-dang-cua-minh image" width="300px">
                            </div>
                            <div class="col-md-8">  
                                {{-- <h3><b> User ID:</b> {{$row->user_id}}</h3> --}}
                                <h3><b>{{$row->name}}</b></h3>
                                {{-- <h4>Đăng trên lớp: {{$row->class_name}}</h4> --}}
