...
<div class="container">
    ...
    <div class="content-border pager-offset">
        <h2 class="black-bar-header">BẢN TIN CỦA GIẢNG VIÊN</h2>
                        ...
                        <div class="col-md-3 col-xs-3">
                            <div class="simple-border">
                                <div class="field field-name-field-article-media field-type-file field-label-hidden">
                                    ...
                                    @else
                                        <a title="" href="{{url('posts'.$row->post_slug)}}">
                                    @endif
                                        <a title="" href="{{url('posts/news/'.$row->category_slug.'/'.$row->post_slug)}}">
                                        <div class="field field-name-field-article-media field-type-file field-label-hidden">
                                            <div class="file file-image file-image-jpeg" id="file-1321">
                                                <img width="320" height="180" alt="" src="{{asset('/images/myfiles_cit/test_posts/31074547-teacher-with-school-objects-flat-design-style.jpg')}}" typeof="foaf:Image">
                                            </div>
                                        </div>
                                    </a>
