...
<div class="container">
    ...
    <div class="content-border pager-offset">
        <h2 class="black-bar-header">BẢN TIN TÌM KIẾM VIỆC LÀM</h2>
                                ...
                                <div class="field field-name-field-article-media field-type-file field-label-hidden">
                                        ...
                                        <div class="field field-name-field-article-media field-type-file field-label-hidden">
                                            <div class="file file-image file-image-jpeg" id="file-1321">
                                                <img width="320" height="180" alt="" src="{{asset('/images/myfiles_cit/test_posts/jobs660_090518050232_103118054303_020119063725.webp')}}" typeof="foaf:Image">
                                            </div>
                                        </div>
                                    </a>
                                ...
                                <div class="field field-name-field-body-medium field-type-text-long field-label-hidden">
                                    ...
                                    <a href="#" class="click_comment" data-post-id="{{$row->post_id}}"><span id="count_comment-{{$row->post_id}}">
                                        ...
                                        <form id="form-{{$row->post_id}}" data-user-id="{{Auth::check() && Auth::user()->user_id}}" style="display: none" data-post-id="{{$row->post_id}}">
                                            ...
                                            <div class="col-md-12">
                                                <div class="col-md-8">
                                                    <textarea name="comment_content" class="form-control" id="contentComment" rows="5"></textarea>
                                                </div>
                                                <div class="col-md-4">
                                        ...
                                        <div id="show-{{$row->post_id}}" class="show-comment-button" data-post-id="{{$row->post_id}}" style="display:none;">
                                            ...
                                            <div class="white-box">
                                                <div class="message-center" id="public-methods" style="width:500px">
                                                    @foreach ($show_comments as $show)
                                                        @if ($show->post_id === $row->post_id)
                                                                @if (Auth::check() && Auth::user()->user_id == $show->user_id)
                                                                    <form action="{{route('posts/submit_comment',$show->comment_id)}}" method="post">
                                                                        @csrf
                                                                        <div class="form-group">
                                                                            <div class="col-md-9">
                                                                                <label for="">{{$show->user['name']}}</label>
                                                                                <input type="text" name="comment_content" id="comment_content" class="form-control" placeholder="" aria-describedby="helpId" value="{{$show->comment_content}}">
                                                                                <small>{{$show->created_at}}</small>
                                                                            </div>
                                                                            <div class="col-md-3">
                                                                                <div class="btn-group">
                                                                                    <i class="icon-options" data-toggle="dropdown"></i>
                                                                                    <ul class="dropdown-menu" role="menu">
                                                                                        <li>
                                                                    ...
                                                                    <form action="{{route('posts/delete_comment',$show->comment_id)}}" method="post" class="delete_form">
                                                                        @csrf
                                                                ...
                                                                @else
                                                                    <form action="{{route('posts/submit_comment',$show->comment_id)}}" method="post">
                                                                        ...
                                                                        <div class="form-group">
                                                                            <div class="col-md-9">
                                                                                <label for="">{{$show->user['name']}}</label>
                                                                                <input type="text" name="comment_content" id="comment_content" class="form-control" placeholder="" aria-describedby="helpId" value="{{$show->comment_content}}" readonly>
                                                                                <small>{{$show->created_at}}</small>
                                                                            </div>
                                                                        </div>
                                                                    </form>
                                                            ...
                                                            {{-- <div class="col-md-12" style="background-color:#dee7f8">
                                                                <div class="col-md-9"><b>{{$show->user['name']}}</b>: {{$show->comment_content}} - {{$show->created_at}}</div> 
                                                                <div class="col-md-3">
                                                                    <div class="btn-group">
                                                                        <i class="icon-options" data-toggle="dropdown"></i>
                                                                        <ul class="dropdown-menu" role="menu">
                                                                            <li>
                                                                            <a id="editComment" data-post-id="{{$show->post_id}}" data-user-id="{{Auth::user()->user_id}}" data-comment-id={{$show->comment_id}}>Edit post</a> 
                                                                            </li>
