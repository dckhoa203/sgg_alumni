...
<div class="container">
    ...
    <div class="content-border pager-offset">
        <h2 class="black-bar-header">BẢN TIN HỖ TRỢ HỌC BỔNG</h2>
                                ...
                                <div class="field field-name-field-article-media field-type-file field-label-hidden">
                                        ...
                                        <div class="field field-name-field-article-media field-type-file field-label-hidden">
                                            <div class="file file-image file-image-jpeg" id="file-1321">
                                                <img width="320" height="180" alt="" src="{{asset('/images/myfiles_cit/test_posts/51963440-modern-thin-line-design-concept-for-support-website-banner-vector-illustration-concept-for-contact-a.jpg')}}" typeof="foaf:Image">
                                            </div>
                                        </div>
                                    </a>
